...
class CAR2 : public Basic_CAR {

public:

	int CAR_Voulme_coeff;									// volume multiplier for other car

	int Recx;																 // Received coords and frame
	int Recy;
	int Frame;

	CAR2(int crszx, int crszy,  int expszx, int expszy, int expframs, int *animseq,
